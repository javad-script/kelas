...
> = {
  ...
  meta: {
    modelProps: 'school' | 'user' | 'classRoom' | 'attendance' | 'attendanceStudent';
    ...
    AttendanceStudent: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.AttendanceStudentCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type AttendanceStudentScalarFieldEnum =
  (typeof AttendanceStudentScalarFieldEnum)[keyof typeof AttendanceStudentScalarFieldEnum];
